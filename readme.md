Below is a Python script using the Solana Python API (solana-py) to create a wallet, derive multiple addresses from it, and check the balances of those addresses.
